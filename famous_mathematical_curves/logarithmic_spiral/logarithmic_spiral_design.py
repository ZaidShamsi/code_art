...
spiral_1 = LogarithmicSpiral(0.4, -0.4, 0.15, 1, 90)
...
plt.pause(1)
fig.savefig('logarithmic_spiral_design(rotated).png')
...
fig.savefig('logarithmic_spiral_design(reflected).png')
